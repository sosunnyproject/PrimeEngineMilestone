...
struct DebugRenderer : public SceneNode
{
	...
	void createTextMesh(const char *str, bool isOverlay2D, bool is3D, bool is3DFacedToCamera, bool is3DFacedToCameraLockedYAxis, float timeToLive, Vector3 pos, float scale, int &threadOwnershipMask, Vector3 rgb = Vector3(1.0, 1.0, 1.0), const char *uiName = NULL);
